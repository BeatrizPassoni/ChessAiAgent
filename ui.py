...
class TextUI:
    ...
    def Draw(self):
        mytext = self.font.render(self.text, True, self.color)
        if self.centered:
...
class Button:
    def __init__(self, screen, x, y, w, h, text):
        ...
        self.fontSize = 24
        # Use a system font instead of an external one
        self.font = pygame.font.SysFont("Arial", self.fontSize)  # Here we use Arial
